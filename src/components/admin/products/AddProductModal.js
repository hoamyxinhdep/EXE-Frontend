...
const AddProductDetail = ({ categories }) => {
  ...
  return (
    <Fragment>
      ...
      >
        <div className="mt-33 md:mt-0 relative bg-white w-100 md:w-3/6 shadow-lg items-center px-6 py-6 md:px-8">
          <div className="flex items-center justify-between w-full pt-4">
            <span className=" font-semibold text-2xl tracking-wide justify-content-center">
              Add Product
            </span>
            {/* Close Modal */}
            <span
